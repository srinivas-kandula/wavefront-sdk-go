...
sender.SendSpan("getAllUsers", 1552949776000, 343, "localhost",
    ...
    nil)
```
Please note that the tracing and span SDK APIs are designed to serve as low-level endpoints only. For most use cases, we recommend using OpenTracing with the Wavefront/OpenTracing SDK: https://github.com/wavefrontHQ/wavefront-opentracing-sdk-go https://github.com/wavefrontHQ/wavefront-opentracing-sdk-go For an example on how to use OpenTracing with Wavefront, please refer to this page: https://github.com/wavefrontHQ/hackathon/tree/master/Wavefront-DT/go-app
